...
<div class="eula-background">
    ...
    <div class="container-fluid main-home-content">
        <div class="back-icon">
            <a href="{{route('q3')}}"><img src="{{asset('svg/back.svg')}}" alt="return_back"> Back</a>
        </div>
            <div class="content-center top-heading">
                <div class="center-text">
                    <h1 class="pt-2">4. Long term goals</h1>
                    <p class="text-green">23% Complete</p>
                </div>

                <div class="questions-container">
                    <form action="{{route('long_term_goals')}}" method="post">
                        @csrf
                    ...
                    <div class="signin-link pt-3">
                        <p>Need a break and continue later? <a href="{{route('save_progress' , ['qno'=> 'q4'])}}" >Save progress</a></p>
                    </div>
                </div>
            </div>
        </div>
