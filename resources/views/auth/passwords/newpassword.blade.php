                    ...
                    <form action="{{route('post.pass.reset')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="password-input">
                                <input type="password" id="passwordField" name="password" class="form-fields" placeholder="Enter Password" value="{{ old('password') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="password-input">
                                <input type="password" id="cnpasswordField" name="cnpassword" class="form-fields" placeholder="Enter Password" value="{{ old('password') }}" required>
