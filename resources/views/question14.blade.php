...
<div class="eula-background">
    ...
    <div class="container-fluid main-home-content">
        <div class="back-icon">
            <a href="{{route('q13')}}"><img src="{{asset('svg/back.svg')}}" alt="return_back"> Back</a>
        </div>
            <div class="content-center">
                ...
                <div class="questions-container">
                    ...
                    <div class="signin-link pt-5">
                        <p>Need a break and continue later? <a href="{{route('save_progress' , ['qno'=> 'q14'])}}" >Save progress</a></p>
                    </div>
                </div>
            </div>
        </div>
